...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        disable: function () {
            ...
            self.$container.find(".btn-file, .fileinput-remove, .kv-fileinput-upload, .image-hide").attr("disabled", true);
            self.initDragDrop();
        },
        enable: function () {
            var self = this;
            ...
            self.$container.find(".btn-file, .fileinput-remove, .kv-fileinput-upload, .image-hide").removeAttr("disabled");
            self.initDragDrop();
        },
