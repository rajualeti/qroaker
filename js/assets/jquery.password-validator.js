...
;(function ( $, window, document, undefined ) {
	...
	"use strict";
		...
		var pluginName = "passwordValidator",
				defaults = {
				length: 12,
				require: ["length", "lower", "digit", "blank", "special"]
		};
		...
		var validators = {
				lower: {
						...
						message: "Contain at least one alphabet"
				},
				digit: {
						validate: function ( password ) {
				...
				blank: {
					validate: function ( password ) {
							return password.match(/^\S+[a-zA-Z0-9-_\S]+$/) != null;
					},
					message: "Not begin or end with a space"
				},
				special: {
					validate: function ( password ) {
							return password.match(/^[ A-Za-z0-9!@#$]*$/) != null;
					},
					message: "Allowed special charaters (!,#,@,$)"
				},
				length: {
